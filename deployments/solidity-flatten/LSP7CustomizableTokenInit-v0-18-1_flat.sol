...
// packages/lsp7-contracts/contracts/extensions/LSP7CappedBalance/ILSP7CappedBalance.sol
...
// packages/lsp7-contracts/contracts/extensions/LSP7NonTransferable/ILSP7NonTransferable.sol

/// @title ILSP7NonTransferable
...
// packages/lsp7-contracts/contracts/extensions/LSP7Revokable/ILSP7Revokable.sol
...
interface ILSP7Revokable {
    ...
    /// @dev Emitted when tokens are revoked from a holder.
    event TokenRevoked(
...
// packages/lsp7-contracts/contracts/extensions/LSP7CappedBalance/LSP7CappedBalanceErrors.sol
...
// packages/lsp7-contracts/contracts/extensions/LSP7CappedSupply/LSP7CappedSupplyErrors.sol
...
// packages/lsp7-contracts/contracts/presets/LSP7CustomizableTokenConstants.sol
...
// packages/lsp7-contracts/contracts/extensions/LSP7NonTransferable/LSP7NonTransferableErrors.sol
...
// packages/lsp7-contracts/contracts/extensions/LSP7Revokable/LSP7RevokableErrors.sol

error LSP7RevokableFeatureDisabled();
    ...
    AccessControlExtendedInitAbstract
{
    ...
    /// and `UNCAPPED_BALANCE_ROLE` exemptions for token contract `owner()`, `address(0)` and `0x...dead` addresses (for burning).
    /// @param name_ The name of the token.
    /// @param symbol_ The symbol of the token.
...
// packages/lsp7-contracts/contracts/extensions/LSP7NonTransferable/LSP7NonTransferableInitAbstract.sol
...
// packages/lsp7-contracts/contracts/extensions/LSP7Revokable/LSP7RevokableInitAbstract.sol
...
// packages/lsp7-contracts/contracts/presets/LSP7CustomizableTokenInit.sol
    ...
    LSP7RevokableInitAbstract
{
    ...
    /// - the total amount of tokens does not exceed the capped supply after minting, from {LSP7CappedSupplyInitAbstract}
    function _mint(
        address to,
        uint256 amount,
        bool force,
