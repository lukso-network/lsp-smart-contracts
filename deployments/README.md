...
| LSP7MintableInit (with `burn()`)           | 0.19.0  | `0x94430626Ad0E3b4716f7c5c2dA92A0F3A3fD63e7` | [**Solidity source code**](https://github.com/lukso-network/lsp-smart-contracts/blob/lsp7-contracts-v0.19.0/packages/lsp7-contracts/contracts/presets/LSP7MintableInit.sol)           |
...
| LSP8MintableInit (with `burn()`)           | 0.19.0  | `0xcc7e0A6900F7947Cce6B7b45AB281F6Ba2014951` | [**Solidity source code**](https://github.com/lukso-network/lsp-smart-contracts/blob/lsp8-contracts-v0.19.0/packages/lsp8-contracts/contracts/presets/LSP8MintableInit.sol)           |
...
The high-level deployment flow works as follows:
...
To deploy the **token base implementation contracts** in one run, use:
...
The artifacts containing the raw creation bytecode + salt for each contract are located inside the `contracts.json` file. You can deploy by pointing the script at the right contract.

Do this by using the right environment variable for the contract to deploy.
