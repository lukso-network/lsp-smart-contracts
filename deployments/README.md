...
| LSP7MintableInit (with `burn()`)           | 0.19.0  | `0xB892FE20CF59ce04449372eaF3D76db242a4b5E0` | [**Solidity source code**](https://github.com/lukso-network/lsp-smart-contracts/blob/lsp7-contracts-v0.19.0/packages/lsp7-contracts/contracts/presets/LSP7MintableInit.sol)           |
