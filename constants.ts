...
export const Errors = {
  LSP1: {
    ...
    "0x4c5e815a": {
      ...
      message:
        "LSP1: Cannot write received vaults/assets on address other than the caller",
    },
    "0x114b721a": {
  ...
  LSP6: {
    ...
    "0x8f4afa38": {
      ...
      message:
        "LSP6: value provided for AddressPermission[index] is not an address.",
    },
    "0x55a187db": {
    ...
    "0x30a324ac": {
      ...
      message:
        "LSP6: `msg.value` sent is not enough to cover all the combined `values[]`.",
    },
    "0xa51868b6": {
      error: "LSP6BatchExcessiveValueSent(uint256,uint256)",
      message:
        "LSP6: cannot send more `msg.value` than all the combined `values[]`.",
    },
    "0x6cb60587": {
    ...
    "0x6fd203c5": {
      ...
      message:
        "LSP6: LSP6: Not allowed to whitelist all calls in AllowedCalls.",
    },
    "0x80d6ebae": {
  ...
  LSP8: {
    ...
    "0x5b271ea2": {
      ...
      message:
        "LSP8: tokenOwner given as parameter does not own this token id.",
    },
    "0x1294d2a9": {
    ...
    "0x5d67d6c1": {
      ...
      message:
        "LSP8: the `from` and `to` address cannot be the same on transfer.",
    },
    "0x34c7b511": {
    ...
    "0xa7626b68": {
      ...
      message:
        "LSP8: Cannot authorize an existing operator twice for the same tokenId.",
    },
    "0x89fdad62": {
  ...
  LSP11: {
    ...
    "0x27113777": {
      ...
      message:
        "LSP11: The guardian number cannot go below the guardians threshold",
    },
    "0xe3db80bd": {
      error: "ThresholdCannotBeHigherThanGuardiansNumber(uint256,uint256)",
      message:
        "LSP11: The guardian threshold cannot be higher than the guardians number",
    },
    "0x7f617002": {
    ...
    "0xf78f0507": {
      ...
      message:
        "LSP11: The caller cannot recover as he didn't reach the guardians threshold",
    },
    "0x6fa723c3": {
...
export const EventSignatures = {
  ...
  LSP16UniversalFactory: {
     ...
     */
    ContractCreated:
      "0xc587425c92859c27d4383bf2eb0ab8ea1670c48039f8d6375b9947b82a20f746",
  },
};
