...
import LSP25MultiChannelNonceTesterArtifacts from '../artifacts/contracts/Mocks/LSP25MultiChannelNonceTester.sol/LSP25MultiChannelNonceTester.json';

const LSP25MultiChannelNonceTester__factory = new ContractFactory(
  LSP25MultiChannelNonceTesterArtifacts.abi,
  LSP25MultiChannelNonceTesterArtifacts.bytecode,
);
/**
...
describe('LSP25MultiChannelNonce', () => {
  let contract: any; // TODO: improve typings
  let account;
  ...
  before(async () => {
    ...
    contract = await LSP25MultiChannelNonceTester__factory.connect(account).deploy();
  });
