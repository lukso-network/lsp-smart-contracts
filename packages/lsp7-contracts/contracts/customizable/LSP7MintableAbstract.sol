...
/// @dev Abstract contract implementing a mintable LSP7 token extension, allowing the owner to mint new tokens until minting is disabled. Inherits from LSP7DigitalAsset to provide core token functionality.
abstract contract LSP7MintableAbstract is LSP7DigitalAsset, ILSP7Mintable {
