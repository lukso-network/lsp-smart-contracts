...
import {MockLSP7NonTransferableInit} from "./mocks/InvariantTestMocks.sol";
import {LSP7NonTransferableInitHandler} from "./handlers/LSP7NonTransferableInitHandler.sol";

/// @dev Invariants 20–23 for LSP7NonTransferableInitAbstract.sol.
/// Run: `FOUNDRY_PROFILE=lsp7 forge test --match-contract LSP7NonTransferableInitAbstractInvariantTest`
contract LSP7NonTransferableInitAbstractInvariantTest is InvariantTest {
    LSP7NonTransferableInitHandler internal handler;
    MockLSP7NonTransferableInit internal token;

    function setUp() public {
        handler = new LSP7NonTransferableInitHandler();
        token = handler.token();
