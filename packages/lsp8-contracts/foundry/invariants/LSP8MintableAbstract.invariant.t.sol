...
import {LSP8MintableHandler} from "./handlers/LSP8MintableHandler.sol";

/// @dev Invariants 47–48 for LSP8MintableAbstract.sol.
/// Run: `FOUNDRY_PROFILE=lsp8 forge test --match-contract LSP8MintableAbstractInvariantTest`
contract LSP8MintableAbstractInvariantTest is InvariantTest {
    LSP8MintableHandler internal handler;
    MockLSP8Mintable internal token;

    function setUp() public {
        handler = new LSP8MintableHandler();
        token = handler.token();
