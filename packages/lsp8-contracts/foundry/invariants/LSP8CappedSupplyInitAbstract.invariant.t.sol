...
import {LSP8CappedSupplyInitHandler} from "./handlers/LSP8CappedSupplyInitHandler.sol";

/// @dev Invariants 45–46 for LSP8CappedSupplyInitAbstract.sol.
/// Run: `FOUNDRY_PROFILE=lsp8 forge test --match-contract LSP8CappedSupplyInitAbstractInvariantTest`
contract LSP8CappedSupplyInitAbstractInvariantTest is InvariantTest {
    LSP8CappedSupplyInitHandler internal handler;
    MockLSP8CappedSupplyInit internal token;

    function setUp() public {
        handler = new LSP8CappedSupplyInitHandler();
        token = handler.token();
    ...
    function invariant_tokenSupplyCapSetOnceOnInit() public {
