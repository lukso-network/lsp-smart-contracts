...
/// @dev Handler for LSP8CustomizableTokenInit preset invariants 26–35 and 40.
contract LSP8CustomizableTokenInitHandler is Test {
    uint256 internal constant NUM_ACTORS = 6;
    address internal constant DEAD_ADDRESS =
        0x000000000000000000000000000000000000dEaD;

    LSP8CustomizableTokenInit public implementation;
    LSP8CustomizableTokenInit public token;
    ...
    constructor() {
        ...
        for (uint256 i; i < NUM_ACTORS; ++i) {
            actors.push(makeAddr(string(abi.encodePacked("lsp8InitActor", i))));
        }
        ...
        implementation = new LSP8CustomizableTokenInit();
