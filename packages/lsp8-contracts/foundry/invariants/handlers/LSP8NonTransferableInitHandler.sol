...
/// @dev Handler for LSP8NonTransferableInitAbstract invariants 49–50.
contract LSP8NonTransferableInitHandler is Test {
    uint256 internal constant NUM_ACTORS = 4;

    MockLSP8NonTransferableInit public implementation;
    MockLSP8NonTransferableInit public token;
    ...
    constructor() {
        ...
        implementation = new MockLSP8NonTransferableInit();
        address instance = Clones.clone(address(implementation));
        token = MockLSP8NonTransferableInit(payable(instance));
