...
/// @dev Handler for LSP8RevokableInitAbstract invariants 51–53.
contract LSP8RevokableInitHandler is Test {
    uint256 internal constant NUM_ACTORS = 5;

    MockLSP8RevokableInit public implementation;
    MockLSP8RevokableInit public token;
    ...
    constructor() {
        ...
        token = MockLSP8RevokableInit(payable(instance));
