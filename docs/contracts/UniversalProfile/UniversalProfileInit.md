...
[`UniversalProfileInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/UniversalProfileInit.sol)
...
- Solidity implementation: [`UniversalProfileInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/UniversalProfileInit.sol)
...
_deploying a `UniversalProfileInit` base contract to be used behind proxy_
