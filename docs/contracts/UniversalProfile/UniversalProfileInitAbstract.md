...
[`UniversalProfileInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/UniversalProfileInitAbstract.sol)

:::

> Inheritable Proxy implementation of a LUKSO's Universal Profile based on LSP3
...
- Solidity implementation: [`UniversalProfileInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/UniversalProfileInitAbstract.sol)
