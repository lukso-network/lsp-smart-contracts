...
[`LSP8AllowlistAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8Allowlist/LSP8AllowlistAbstract.sol)

:::

> LSP8AllowlistAbstract

Abstract contract implementing an allowlist for LSP8 tokens, allowing specific addresses to bypass restrictions such as transfer locks. Inherits from LSP8IdentifiableDigitalAsset to integrate with token functionality.
...
- Solidity implementation: [`LSP8AllowlistAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8Allowlist/LSP8AllowlistAbstract.sol)
