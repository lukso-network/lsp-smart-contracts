...
[`LSP8MintableInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/presets/LSP8MintableInitAbstract.sol)

:::

> Implementation of a LSP8 Identifiable Digital Asset, a contract that represents a non-fungible token.

LSP8IdentifiableDigitalAsset deployable preset contract (inheritable proxy version) with a public [`mint`](#mint) function callable only by the contract [`owner`](#owner).
...
- Solidity implementation: [`LSP8MintableInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/presets/LSP8MintableInitAbstract.sol)
