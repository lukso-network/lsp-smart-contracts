...
[`LSP8VotesInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8VotesInitAbstract.sol)
...
- Solidity implementation: [`LSP8VotesInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8VotesInitAbstract.sol)
...
Adjusts votes when tokens are transferred. Emits a [`IVotes-DelegateVotesChanged`](#ivotes-delegatevoteschanged) event.
...
```solidity
function __Votes_init() internal nonpayable;
```

<br/>

### \_\_Votes_init_unchained

```solidity
function __Votes_init_unchained() internal nonpayable;
```
