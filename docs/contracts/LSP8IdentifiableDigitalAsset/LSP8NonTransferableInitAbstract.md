...
[`LSP8NonTransferableInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8NonTransferable/LSP8NonTransferableInitAbstract.sol)

:::

> LSP8NonTransferableInitAbstract

Abstract contract implementing non-transferable LSP8 token functionality with transfer lock periods and allowlist support.
...
- Solidity implementation: [`LSP8NonTransferableInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8NonTransferable/LSP8NonTransferableInitAbstract.sol)
