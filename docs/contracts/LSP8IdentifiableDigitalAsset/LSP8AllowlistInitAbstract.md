...
[`LSP8AllowlistInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8Allowlist/LSP8AllowlistInitAbstract.sol)

:::

> LSP8AllowlistInitAbstract

Abstract contract implementing an allowlist for LSP8 tokens, allowing specific addresses to bypass restrictions such as transfer locks. Inherits from LSP8IdentifiableDigitalAssetInitAbstract to integrate with token functionality.
...
- Solidity implementation: [`LSP8AllowlistInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8Allowlist/LSP8AllowlistInitAbstract.sol)
