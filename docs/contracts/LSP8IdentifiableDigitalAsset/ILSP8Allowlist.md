...
[`ILSP8Allowlist.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8Allowlist/ILSP8Allowlist.sol)

:::

> ILSP8Allowlist

Interface for managing an allowlist of addresses that can bypass certain restrictions in an LSP8 token contract.
...
- Solidity implementation: [`ILSP8Allowlist.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8Allowlist/ILSP8Allowlist.sol)
