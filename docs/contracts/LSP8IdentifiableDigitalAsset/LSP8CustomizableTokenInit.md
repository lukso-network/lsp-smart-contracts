...
[`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)

:::

> LSP8CustomizableTokenInit

A customizable LSP8 token implementing minting, balance caps, transfer restrictions, total supply cap, burning and allowlist exemptions. This is the proxy-deployable version. Implements [`LSP8Mintable`](#lsp8mintable) to allow minting. Implements [`LSP8Burnable`](#lsp8burnable) to allow burning Implements [`LSP8CappedBalance`](#lsp8cappedbalance) to set balance caps. Implements [`LSP8NonTransferable`](#lsp8nontransferable) to restrict transfers. Implements [`LSP8CappedSupply`](#lsp8cappedsupply) to set total supply cap. Implements [`LSP8Allowlist`](#lsp8allowlist) to create allowlist exemptions
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#constructor)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
_Deploying a LSP8IdentifiableDigitalAsset with name `name_`, symbol `symbol_`, owned by address `newOwner_` with tokenId format `lsp8TokenIdFormat_`._

Locks the base implementation contract from being initialized.
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#addtoallowlist)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#burn)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#disableminting)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#getallowlistedaddressesbyindex)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#getallowlistedaddresseslength)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#initialize)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Function signature: `initialize(string,string,address,uint256,uint256,MintableParamsInit,NonTransferableParamsInit,CappedParamsInit)`
- Function selector: `0x1b6a0055`
...
function initialize(
  ...
  struct MintableParamsInit mintableParams,
  struct NonTransferableParamsInit nonTransferableParams,
  struct CappedParamsInit cappedParams
)
  external nonpayable;
```

_Initializes the token with name, symbol, owner, and customizable features._

Sets up minting, balance cap, transfer restrictions, allowlist, and supply cap. Mints initial tokens if specified. Reverts if initialMintTokenIds length exceeds tokenSupplyCap.
...
| `newOwner_`             |             `address`              | The initial owner of the token, added to the allowlist.                             |
| `lsp4TokenType_`        |             `uint256`              | The LSP4 token type (e.g., 1 for NFT, 2 for Collection).                            |
| `lsp8TokenIdFormat_`    |             `uint256`              | The format of tokenIds (= NFTs) that this contract will create.                     |
| `mintableParams`        |    `struct MintableParamsInit`     | Deployment configuration for minting feature (see above).                           |
| `nonTransferableParams` | `struct NonTransferableParamsInit` | Deployment configuration for non-transferable feature (see above).                  |
| `cappedParams`          |     `struct CappedParamsInit`      | Deployment configuration for capped balance and capped supply features (see above). |
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#isallowlisted)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#ismintable)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Function signature: `isMintable()`
- Function selector: `0x46b45af7`
...
_Indicates whether minting is currently enabled._
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#mint)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
_Mints a new token with the specified tokenId to a given address._

Mints a token with `tokenId` to `to`, callable only by the contract owner. Emits a Transfer event as defined in ILSP8IdentifiableDigitalAsset. Reverts if `to` is the zero address, if minting is disabled, or if the tokenId already exists.
...
| `tokenId` | `bytes32` | The unique identifier for the token to mint.                                                             |
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#removefromallowlist)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
| `symbol_`               |              `string`              | -           |
| `newOwner_`             |             `address`              | -           |
| `lsp4TokenType_`        |             `uint256`              | -           |
| `lsp8TokenIdFormat_`    |             `uint256`              | -           |
| `mintableParams`        |    `struct MintableParamsInit`     | -           |
| `nonTransferableParams` | `struct NonTransferableParamsInit` | -           |
| `cappedParams`          |     `struct CappedParamsInit`      | -           |
...
Relies on [`LSP8CappedSupply`](#lsp8cappedsupply) for supply cap enforcement.
...
_Hook called before a token transfer to enforce restrictions._

Combines checks from [`LSP8CappedBalance`](#lsp8cappedbalance) and [`LSP8NonTransferable`](#lsp8nontransferable). Bypasses all checks for allowlisted senders (from [`LSP8NonTransferable`](#lsp8nontransferable)) or recipients (from [`LSP8CappedBalance`](#lsp8cappedbalance)). Allows burning to address(0) regardless of restrictions.
...
| `tokenId` | `bytes32` | The unique identifier of the token being transferred. |
| `force`   |  `bool`   | Whether to force the transfer.                        |
| `data`    |  `bytes`  | Additional data for the transfer.                     |

<br/>

### \_\_LSP8CappedSupply_init
...
_Initializes the LSP8CappedSupply contract with base token params and supply cap._

Initializes the LSP8IdentifiableDigitalAsset base and sets the maximum token supply cap.
...
| `lsp4TokenType_`     | `uint256` | The token type (see LSP4).                                      |
| `lsp8TokenIdFormat_` | `uint256` | The format of tokenIds (= NFTs) that this contract will create. |
| `tokenSupplyCap_`    | `uint256` | The maximum total supply, 0 to disable.                         |

<br/>

### \_\_LSP8CappedSupply_init_unchained
...
_Unchained initializer for the token supply cap._

Sets the maximum token supply cap.
...
Checks if minting a new token would exceed the token supply cap.
...
_Initializes the LSP8CappedBalance contract with base token params and balance cap._

Initializes the LSP8Allowlist (which initializes LSP8IdentifiableDigitalAsset) and sets the balance cap.
...
| `name_`              | `string`  | The name of the token.                                          |
| `symbol_`            | `string`  | The symbol of the token.                                        |
| `newOwner_`          | `address` | The owner of the contract, added to the allowlist.              |
| `lsp4TokenType_`     | `uint256` | The token type (see LSP4).                                      |
| `lsp8TokenIdFormat_` | `uint256` | The format of tokenIds (= NFTs) that this contract will create. |
| `tokenBalanceCap_`   | `uint256` | The maximum number of NFTs per address, 0 to disable.           |

<br/>

### \_\_LSP8CappedBalance_init_unchained
...
_Unchained initializer for the balance cap._

Sets the balance cap.
...
_Checks if a token transfer complies with the balance cap._

The address(0) is not subject to balance cap checks as this address is used for burning tokens. Reverts with [`LSP8CappedBalanceExceeded`](#lsp8cappedbalanceexceeded) if the recipient's NFT count after receiving the token would exceed the maximum allowed.
...
_Initializes the LSP8NonTransferable contract with base token params, allowlist, and transfer settings._

Initializes the LSP8Allowlist (which initializes LSP8IdentifiableDigitalAsset) and sets transfer settings.
...
| `lsp4TokenType_`     | `uint256` | The token type (see LSP4).                                      |
| `lsp8TokenIdFormat_` | `uint256` | The format of tokenIds (= NFTs) that this contract will create. |
| `transferLockStart_` | `uint256` | The start timestamp of the transfer lock period, 0 to disable.  |
| `transferLockEnd_`   | `uint256` | The end timestamp of the transfer lock period, 0 to disable.    |

<br/>

### \_\_LSP8NonTransferable_init_unchained
...
_Unchained initializer for the transfer settings._
...
_Checks if a token transfer is allowed based on transferability status._

Allows burning to address(0) even when transfers are disabled, bypassing transferability restrictions. Reverts with [`LSP8TransferDisabled`](#lsp8transferdisabled) if the token is non-transferable and the destination is not address(0).
...
_Initializes the LSP8Allowlist contract with base token params and allowlist._

Initializes the LSP8IdentifiableDigitalAsset base and sets up the allowlist with owner and zero address.
...
### \_\_LSP8Allowlist_init_unchained

```solidity
function __LSP8Allowlist_init_unchained(address newOwner_) internal nonpayable;
```

_Unchained initializer for the allowlist._

Adds the contract owner, `address(0)`, and the dead address to the allowlist.

#### Parameters

| Name        |   Type    | Description                          |
| ----------- | :-------: | ------------------------------------ |
| `newOwner_` | `address` | The address to add to the allowlist. |

<br/>

### \_\_LSP8Mintable_init

:::info

If `mintable_` is set to `true` then it can be disabled using `disableMinting()` function later on.
...
_Initializes the LSP8Mintable contract with base token params and minting status._

Initializes the LSP8IdentifiableDigitalAsset base and sets the initial minting status.
...
| `lsp4TokenType_`     | `uint256` | The token type (see LSP4).                                            |
| `lsp8TokenIdFormat_` | `uint256` | The format of tokenIds (= NFTs) that this contract will create.       |
| `mintable_`          |  `bool`   | True to enable minting after deployment, false to disable it forever. |

<br/>

### \_\_LSP8Mintable_init_unchained

```solidity
function __LSP8Mintable_init_unchained(bool mintable_) internal nonpayable;
```

_Unchained initializer for the minting status._

Sets the initial minting status.
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#allowlistchanged)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#mintingstatuschanged)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8allowlistcannotremovereservedaddress)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Error signature: `LSP8AllowListCannotRemoveReservedAddress(address)`
- Error hash: `0x521083ec`

:::

```solidity
error LSP8AllowListCannotRemoveReservedAddress(address reservedAddress);
```

Error thrown when attempting to remove a reserved address from the allowlist.

#### Parameters

| Name              |   Type    | Description                                                            |
| ----------------- | :-------: | ---------------------------------------------------------------------- |
| `reservedAddress` | `address` | The address that cannot be removed (e.g., address(0) or dead address). |
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8allowlistinvalidindexrange)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Error signature: `LSP8AllowListInvalidIndexRange(uint256,uint256,uint256)`
- Error hash: `0x7a4e45bd`

:::

```solidity
error LSP8AllowListInvalidIndexRange(
  uint256 startIndex,
  uint256 endIndex,
  uint256 length
);
...
Error thrown when querying the allowlist with an invalid index range.

#### Parameters

| Name         |   Type    | Description                          |
| ------------ | :-------: | ------------------------------------ |
| `startIndex` | `uint256` | The start index provided.            |
| `endIndex`   | `uint256` | The end index provided.              |
| `length`     | `uint256` | The current length of the allowlist. |
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8cannotupdatetransferlockperiod)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Error signature: `LSP8CannotUpdateTransferLockPeriod()`
- Error hash: `0x18d504ce`
...
Error thrown when attempting to update the transfer lock period after it has begun.
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8cappedbalanceexceeded)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Error signature: `LSP8CappedBalanceExceeded(address,uint256,uint256)`
- Error hash: `0xe6bf112c`
...
Error thrown when a transfer would cause an address's NFT count to exceed the token balance cap.
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8cappedsupplycannotmintovercap)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8invalidtransferlockperiod)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Error signature: `LSP8InvalidTransferLockPeriod()`
- Error hash: `0x9e33937e`
...
Error thrown when the transfer lock period is invalid, such as when the end timestamp is earlier than the start timestamp.
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8mintdisabled)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Error signature: `LSP8MintDisabled()`
- Error hash: `0x4d8af03d`
...
Error thrown when attempting to mint tokens after minting has been disabled.
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8tokenalreadytransferable)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Error signature: `LSP8TokenAlreadyTransferable()`
- Error hash: `0xe8587b0b`
...
Error thrown when attempting to make a token transferable that is already transferable.
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8tokenidalreadyminted)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
...
- Specification details: [**LSP-8-IdentifiableDigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-8-IdentifiableDigitalAsset.md#lsp8transferdisabled)
- Solidity implementation: [`LSP8CustomizableTokenInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/LSP8CustomizableTokenInit.sol)
- Error signature: `LSP8TransferDisabled()`
- Error hash: `0x9ade4142`
...
Error thrown when attempting a token transfer while transfers are disabled.
...
Reverts when trying to set `address(0)` as the contract owner when deploying the contract or initializing it.
