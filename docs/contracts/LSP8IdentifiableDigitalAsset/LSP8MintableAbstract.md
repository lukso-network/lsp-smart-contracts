...
[`LSP8MintableAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8Mintable/LSP8MintableAbstract.sol)

:::

> LSP8MintableAbstract

Abstract contract implementing a mintable LSP8 token extension, allowing the owner to mint new tokens until minting is disabled. Inherits from LSP8IdentifiableDigitalAsset to provide core token functionality.
...
- Solidity implementation: [`LSP8MintableAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp8-contracts/contracts/extensions/LSP8Mintable/LSP8MintableAbstract.sol)
...
Checks if minting is enabled, reverting with LSP8MintDisabled if not. Calls the parent \_mint function from LSP8IdentifiableDigitalAsset.
