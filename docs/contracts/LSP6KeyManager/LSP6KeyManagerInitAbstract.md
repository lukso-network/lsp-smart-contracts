...
[`LSP6KeyManagerInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp6-contracts/contracts/LSP6KeyManagerInitAbstract.sol)
...
- Solidity implementation: [`LSP6KeyManagerInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp6-contracts/contracts/LSP6KeyManagerInitAbstract.sol)
