...
[`LSP6KeyManagerInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp6-contracts/contracts/LSP6KeyManagerInit.sol)
...
- Solidity implementation: [`LSP6KeyManagerInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp6-contracts/contracts/LSP6KeyManagerInit.sol)
