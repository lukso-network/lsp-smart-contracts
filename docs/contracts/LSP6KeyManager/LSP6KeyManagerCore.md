...
[`LSP6KeyManagerCore.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp6-contracts/contracts/LSP6KeyManagerCore.sol)

:::

> Core implementation of the LSP6 Key Manager standard.

This contract acts as a controller for an ERC725 Account. Permissions for controllers are stored in the ERC725Y storage of the ERC725 Account and can be updated using `setData(...)`.
...
- Solidity implementation: [`LSP6KeyManagerCore.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp6-contracts/contracts/LSP6KeyManagerCore.sol)
