...
[`LSP4DigitalAssetMetadataInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp4-contracts/contracts/LSP4DigitalAssetMetadataInitAbstract.sol)
...
Inheritable Proxy Implementation of the LSP4 standard.
...
- Solidity implementation: [`LSP4DigitalAssetMetadataInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp4-contracts/contracts/LSP4DigitalAssetMetadataInitAbstract.sol)
...
- Specification details: [**LSP-4-DigitalAsset-Metadata**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-4-DigitalAsset-Metadata.md#initialized)
- Solidity implementation: [`LSP4DigitalAssetMetadataInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp4-contracts/contracts/LSP4DigitalAssetMetadataInitAbstract.sol)
