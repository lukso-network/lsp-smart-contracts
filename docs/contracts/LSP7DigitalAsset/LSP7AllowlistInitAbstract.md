...
[`LSP7AllowlistInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Allowlist/LSP7AllowlistInitAbstract.sol)

:::

> LSP7AllowlistInitAbstract

Abstract contract implementing an \_allowlist for LSP7 tokens, allowing specific addresses to bypass restrictions such as transfer locks. Inherits from LSP7DigitalAsset to integrate with token functionality.
...
- Solidity implementation: [`LSP7AllowlistInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Allowlist/LSP7AllowlistInitAbstract.sol)
