...
[`ILSP7CappedSupply.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7CappedSupply/ILSP7CappedSupply.sol)

:::

> ILSP7CappedSupply

Interface for an LSP7 token extension that enforces a max token supply cap.
...
- Solidity implementation: [`ILSP7CappedSupply.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7CappedSupply/ILSP7CappedSupply.sol)
