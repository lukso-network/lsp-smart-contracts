...
[`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)

:::

> Implementation of the LSP7 Digital Asset standard, a contract that represents a fungible token.

Extension of LSP7 to support Compound-like voting and delegation. This version is more generic than Compound's, and supports token supply up to 2^224^

- 1, while COMP is limited to 2^96^

-

1. This extension keeps a history (checkpoints) of each account's vote power. Vote power can be delegated either by calling the [`delegate`](#delegate) function directly, or by providing a signature to be used with [`delegateBySig`](#delegatebysig). Voting power can be queried through the public accessors [`getVotes`](#getvotes) and [`getPastVotes`](#getpastvotes). By default, token balance does not account for voting power. This makes transfers cheaper. The downside is that it requires users to delegate to themselves in order to activate checkpoints and have their voting power tracked.
...
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#clock_mode)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `CLOCK_MODE()`
- Function selector: `0x4bf5d7e9`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#domain_separator)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `DOMAIN_SEPARATOR()`
- Function selector: `0x3644e515`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#checkpoints)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `checkpoints(address,uint32)`
- Function selector: `0xf1127ed8`
...
function checkpoints(address account, uint32 pos)
  external view
  returns (struct LSP7Votes.Checkpoint);
```
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#clock)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `clock()`
- Function selector: `0x91ddadf4`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#delegate)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `delegate(address)`
- Function selector: `0x5c19a95c`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#delegatebysig)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `delegateBySig(address,uint256,uint256,uint8,bytes32,bytes32)`
- Function selector: `0xc3cda520`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#delegates)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `delegates(address)`
- Function selector: `0x587cde1e`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#eip712domain)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `eip712Domain()`
- Function selector: `0x84b0196e`
...
See [`EIP-5267`](#eip-5267). _Available since v4.9._
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#getpasttotalsupply)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `getPastTotalSupply(uint256)`
- Function selector: `0x8e539e8c`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#getpastvotes)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `getPastVotes(address,uint256)`
- Function selector: `0x3a46b1a8`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#getvotes)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `getVotes(address)`
- Function selector: `0x9ab24eb0`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#nonces)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `nonces(address)`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#numcheckpoints)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Function signature: `numCheckpoints(address)`
- Function selector: `0x6fcfff45`
...
```solidity
function _maxSupply() internal view returns (uint224);
```

Maximum token supply. Defaults to `type(uint224).max` (2^224^
...
- [`DelegateVotesChanged`](#delegatevoteschanged) when voting power is removed from source address
- [`DelegateVotesChanged`](#delegatevoteschanged) when voting power is added to destination address
...
```solidity
function _delegate(address delegator, address delegatee) internal nonpayable;
```
...
```solidity
function _useNonce(address owner) internal nonpayable returns (uint256 current);
```
...
Given an [**already**](https://eips.ethereum.org/EIPS/eip-712#definition-of-hashstruct[hashed) struct], this function returns the hash of the fully encoded EIP712 message for this domain. This hash can be used together with [`ECDSA-recover`](#ecdsa-recover) to obtain the signer of a message. For example: `solidity bytes32 digest = _hashTypedDataV4(keccak256(abi.encode( keccak256("Mail(address to,string contents)"), mailTo, keccak256(bytes(mailContents)) ))); address signer = ECDSA.recover(digest, signature); `
...
Hook that is called before any token transfer, including minting and burning. Allows to run custom logic before updating balances and notifying sender/recipient by overriding this function.
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#delegatechanged)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Event signature: `DelegateChanged(address,address,address)`
- Event topic hash: `0x3134e8a2e6d97e929a7e54011ea5485d7d196dd5f0ba4d4ef95803e8e3fc257f`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#delegatevoteschanged)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Event signature: `DelegateVotesChanged(address,uint256,uint256)`
- Event topic hash: `0xdec2bacdd2f05b59de34da9b523dff8be42e5e38e818c82fdb0bae774387a724`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#eip712domainchanged)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Event signature: `EIP712DomainChanged()`
- Event topic hash: `0x0a6387c9ea3628b88a633bb4f3b151770f70085117a15f9bf3787cda53f13d31`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#invalidshortstring)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Error signature: `InvalidShortString()`
- Error hash: `0xb3512b0c`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#lsp7votesbrokenclockmode)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Error signature: `LSP7VotesBrokenClockMode()`
- Error hash: `0x631ceb64`
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#lsp7votesexceededsafesupply)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Error signature: `LSP7VotesExceededSafeSupply(uint256,uint256)`
- Error hash: `0xdac920f1`
...
Reverts when the total supply of tokens is greater than the token supply cap.
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#lsp7votesfuturelookup)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Error signature: `LSP7VotesFutureLookup(uint256)`
- Error hash: `0x824ef7b7`
...
Reverts when attempting to lookup a previous votes or total supply for a timepoint in the future.
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#lsp7votesinvalidnonce)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Error signature: `LSP7VotesInvalidNonce(address,uint256)`
- Error hash: `0x308d5651`
...
Reverts when the `nonce` for `signer` is invalid.
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#lsp7votessignatureexpired)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Error signature: `LSP7VotesSignatureExpired(uint256)`
- Error hash: `0x6441b62a`
...
Reverts when a signature is expired.
...
- Specification details: [**LSP-7-DigitalAsset**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-7-DigitalAsset.md#stringtoolong)
- Solidity implementation: [`LSP7Votes.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Votes.sol)
- Error signature: `StringTooLong(string)`
- Error hash: `0x305a27a9`
