...
[`LSP7AllowlistAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Allowlist/LSP7AllowlistAbstract.sol)

:::

> LSP7AllowlistAbstract

Abstract contract implementing an allowlist for LSP7 tokens, allowing specific addresses to bypass restrictions such as transfer locks. Inherits from LSP7DigitalAsset to integrate with token functionality.
...
- Solidity implementation: [`LSP7AllowlistAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7Allowlist/LSP7AllowlistAbstract.sol)
