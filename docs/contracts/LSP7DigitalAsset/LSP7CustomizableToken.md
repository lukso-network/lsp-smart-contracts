...
[`LSP7CustomizableToken.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/LSP7CustomizableToken.sol)

:::

> LSP7CustomizableToken

A customizable LSP7 token implementing minting, balance caps, transfer restrictions, total supply cap, burning and allowlist exemptions. Implements [`LSP7Mintable`](#lsp7mintable) to allow minting. Implements [`LSP7Burnable`](#lsp7burnable) to allow burning Implements [`LSP7CappedBalance`](#lsp7cappedbalance) to set balance caps. Implements [`LSP7NonTransferable`](#lsp7nontransferable) to restrict transfers. Implements [`LSP7CappedSupply`](#lsp7cappedsupply) to set total supply cap. Implements [`LSP7Allowlist`](#lsp7allowlist) to create allowlist exemptions
...
- Solidity implementation: [`LSP7CustomizableToken.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/LSP7CustomizableToken.sol)
...
Relies on [`LSP7CappedSupply`](#lsp7cappedsupply) for supply cap enforcement.
...
Combines checks from [`LSP7CappedBalance`](#lsp7cappedbalance) and [`LSP7NonTransferable`](#lsp7nontransferable). Bypasses all checks for allowlisted senders (from [`LSP7NonTransferable`](#lsp7nontransferable)) or recipients (from [`LSP7CappedBalance`](#lsp7cappedbalance)). Allows burning to address(0) regardless of restrictions.
...
Transfers `amount` of tokens from `from` to `to`. Alternatively mints or burns if `from` or `to` is the zero address.
