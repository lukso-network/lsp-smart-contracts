...
[`LSP7VotesInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7VotesInitAbstract.sol)

:::

> Proxy Implementation of the LSP7 Digital Asset standard, a contract that represents a fungible token.
...
- Solidity implementation: [`LSP7VotesInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7VotesInitAbstract.sol)
...
function checkpoints(address account, uint32 pos)
  external view
  returns (struct LSP7VotesInitAbstract.Checkpoint);
```
...
| Name |                   Type                    | Description |
| ---- | :---------------------------------------: | ----------- |
| `0`  | `struct LSP7VotesInitAbstract.Checkpoint` | -           |
...
```solidity
function __EIP712_init(string name, string version) internal nonpayable;
```
