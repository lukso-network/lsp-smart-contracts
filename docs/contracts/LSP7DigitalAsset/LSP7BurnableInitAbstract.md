...
[`LSP7BurnableInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7BurnableInitAbstract.sol)
...
This contract implement the core logic of the functions for the [`ILSP7DigitalAsset`](#ilsp7digitalasset) interface. Minting and transferring are supplied with a `uint256` amount. This implementation is agnostic to the way tokens are created. A supply mechanism has to be added in a derived contract using [`_mint`](#_mint) For a generic mechanism, see [`LSP7MintableInitAbstract`](#lsp7mintableinitabstract).
...
- Solidity implementation: [`LSP7BurnableInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7BurnableInitAbstract.sol)
