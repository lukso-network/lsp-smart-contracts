...
[`ILSP7NonTransferable.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7NonTransferable/ILSP7NonTransferable.sol)

:::

> ILSP7NonTransferable

Interface for a non-transferable LSP7 token, enabling control over transferability, lock periods, and allowlist exemptions.
...
- Solidity implementation: [`ILSP7NonTransferable.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/extensions/LSP7NonTransferable/ILSP7NonTransferable.sol)
