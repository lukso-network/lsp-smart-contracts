...
[`LSP7MintableInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7MintableInit.sol)

:::

> LSP7MintableInitAbstract

LSP7DigitalAsset deployable preset contract (proxy version) with a public [`mint`](#mint) function callable only by the contract [`owner`](#owner).
...
- Solidity implementation: [`LSP7MintableInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7MintableInit.sol)
...
- Solidity implementation: [`LSP7MintableInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7MintableInit.sol)
- Function signature: `initialize(string,string,address,uint256,bool,bool)`
- Function selector: `0x68ce2516`
...
_Initializing a `LSP7MintableInit` token contract._
...
| `mintable_`       |  `bool`   | True to enable minting initially, false to disable it.                                               |
...
_Internal function to mint tokens, overridden to enforce minting status._

Checks if minting is enabled, reverting with LSP7MintDisabled if not. Calls the parent \_mint function from LSP7DigitalAsset.
