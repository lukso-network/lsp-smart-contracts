...
[`LSP7Mintable.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7Mintable.sol)

:::

> LSP7DigitalAsset deployable preset contract with a public [`mint`](#mint) function callable only by the contract [`owner`](#owner).
...
- Solidity implementation: [`LSP7Mintable.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7Mintable.sol)
...
_Deploying a `LSP7Mintable` token contract._

Sets the initial minting status. Inherits LSP7DigitalAsset constructor logic.
