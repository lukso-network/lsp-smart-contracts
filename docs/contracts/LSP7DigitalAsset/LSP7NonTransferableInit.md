...
[`LSP7NonTransferableInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7NonTransferableInit.sol)

:::

> LSP7NonTransferableInitAbstract

Abstract contract implementing non-transferable LSP7 token functionality with transfer lock periods and allowlist support.
...
- Solidity implementation: [`LSP7NonTransferableInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7NonTransferableInit.sol)
...
_Sets the token-Metadata_

initialize (= lock) base implementation contract on deployment
...
- Solidity implementation: [`LSP7NonTransferableInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7NonTransferableInit.sol)
- Function signature: `initialize(string,string,address,uint256,bool,uint256,uint256)`
- Function selector: `0xb33e0298`
...
_Deploying a `LSP7NonTransferableInit` token contract._
...
_Hook called before a token transfer to enforce transfer restrictions._

Bypasses transfer restrictions for addresses in the allowlist, allowing them to transfer tokens even when [`isTransferable`](#istransferable) returns false. For non-allowlisted addresses, applies non-transferable checks.
...
| `force`  |  `bool`   | Whether to force the transfer (passed to \_nonTransferableCheck).    |
| `data`   |  `bytes`  | Additional data for the transfer (passed to \_nonTransferableCheck). |
