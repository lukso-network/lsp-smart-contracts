...
[`LSP7CappedBalance.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7CappedBalance.sol)
...
- Solidity implementation: [`LSP7CappedBalance.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7CappedBalance.sol)
...
_Deploying a `LSP7CappedBalance` token contract._

Sets the immutable balance cap and reverts if the cap is zero. Inherits LSP7AllowlistAbstract constructor logic.
