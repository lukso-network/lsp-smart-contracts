...
[`LSP7CappedBalanceInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7CappedBalanceInit.sol)

:::

> LSP7CappedBalanceInitAbstract

Abstract contract implementing a per-address balance cap for LSP7 tokens, with exemptions for allowlisted addresses. Inherits from LSP7AllowlistAbstract to integrate allowlist functionality.
...
- Solidity implementation: [`LSP7CappedBalanceInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7CappedBalanceInit.sol)
...
- Solidity implementation: [`LSP7CappedBalanceInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp7-contracts/contracts/presets/LSP7CappedBalanceInit.sol)
- Function signature: `initialize(string,string,address,uint256,bool,uint256)`
- Function selector: `0x0c0c89a0`
...
_Deploying a `LSP7CappedBalanceInit` token contract._
...
_Hook called before a token transfer to enforce balance cap restrictions._

Bypasses balance cap checks for allowlisted recipients. Applies cap checks for non-allowlisted recipients.
