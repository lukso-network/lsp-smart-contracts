...
[`LSP9VaultInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp9-contracts/contracts/LSP9VaultInit.sol)
...
- Solidity implementation: [`LSP9VaultInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp9-contracts/contracts/LSP9VaultInit.sol)
...
- Specification details: [**LSP-9-Vault**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-9-Vault.md#initialize)
- Solidity implementation: [`LSP9VaultInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp9-contracts/contracts/LSP9VaultInit.sol)
...
_Initializing a LSP9Vault contract with owner set to address `initialOwner`._
...
- [`DataChanged`](#datachanged) event when updating the [`_LSP9_SUPPORTED_STANDARDS_KEY`](#_lsp9_supported_standards_key).
...
```solidity
function _initialize(address newOwner) internal nonpayable;
```
...
- Specification details: [**LSP-9-Vault**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-9-Vault.md#initialized)
- Solidity implementation: [`LSP9VaultInit.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp9-contracts/contracts/LSP9VaultInit.sol)
