...
[`LSP9VaultInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp9-contracts/contracts/LSP9VaultInitAbstract.sol)

:::

> Inheritable Proxy Implementation of LSP9Vault built on top of ERC725, LSP1UniversalReceiver
...
- Solidity implementation: [`LSP9VaultInitAbstract.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp9-contracts/contracts/LSP9VaultInitAbstract.sol)
