...
[`UniversalProfileInitPostDeploymentModule.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/modules/UniversalProfileInitPostDeploymentModule.sol)
...
- Solidity implementation: [`UniversalProfileInitPostDeploymentModule.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/modules/UniversalProfileInitPostDeploymentModule.sol)
...
_Deploying a LSP6KeyManagerInit to be used as base contract behind proxy._
...
Be aware that `msg.value` is persisting between the caller and the callee when using `DELEGATECALL` (`4`) as `operationType`.
...
- [`UniversalReceiver`](#universalreceiver) event with typeId [`LSP0ValueReceived`](#`lsp0valuereceived`) when receiving native tokens.
...
- Specification details: [**UniversalProfile**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-3-UniversalProfile-Metadata.md#executepostdeployment)
- Solidity implementation: [`UniversalProfileInitPostDeploymentModule.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/modules/UniversalProfileInitPostDeploymentModule.sol)
...
- Specification details: [**UniversalProfile**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-3-UniversalProfile-Metadata.md#initialize)
- Solidity implementation: [`UniversalProfileInitPostDeploymentModule.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/modules/UniversalProfileInitPostDeploymentModule.sol)
- Function signature: `initialize(address)`
- Function selector: `0xc4d66de8`
...
_Initializing a UniversalProfile contract with owner set to address `initialOwner`._
...
- Specification details: [**UniversalProfile**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-3-UniversalProfile-Metadata.md#setdataandtransferownership)
- Solidity implementation: [`UniversalProfileInitPostDeploymentModule.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/modules/UniversalProfileInitPostDeploymentModule.sol)
- Function signature: `setDataAndTransferOwnership(bytes32[],bytes[],address)`
- Function selector: `0x4f04d60a`
...
- [`UniversalReceiver`](#universalreceiver) with typeId [`LSP0ValueReceived`](#`lsp0valuereceived`) when receiving native tokens.
...
ERC725X & ERC725Y parent contracts are not initialised as they don't have non-zero initial state. If you decide to add non-zero initial state to any of those contracts, you must initialize them here.
...
Set `initialOwner` as the contract owner and the `SupportedStandards:LSP3Profile` data key in the ERC725Y data key/value store. The `initialOwner` will then be allowed to call protected functions marked with the `onlyOwner` modifier.
...
- Reverts with no reason if the data returned by `ILSP20(logicVerifier).lsp20VerifyCall(...)` cannot be decoded (_e.g:_ any other data type besides `bytes4`). See this link for more info: https://forum.soliditylang.org/t/call-for-feedback-the-future-of-try-catch-in-solidity/1497.
...
- Reverts with no reason if the data returned by `ILSP20(logicVerifier).lsp20VerifyCallResult(...)` cannot be decoded (_e.g:_ any other data type besides `bytes4`). See this link for more info: https://forum.soliditylang.org/t/call-for-feedback-the-future-of-try-catch-in-solidity/1497.
...
Write a `dataValue` to the underlying ERC725Y storage, represented as a mapping of `bytes32` data keys mapped to their `bytes` data values. `solidity mapping(bytes32 => bytes) _store `
...
- Specification details: [**UniversalProfile**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-3-UniversalProfile-Metadata.md#initialized)
- Solidity implementation: [`UniversalProfileInitPostDeploymentModule.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/universalprofile-contracts/contracts/modules/UniversalProfileInitPostDeploymentModule.sol)
