...
[`KeyManagerInitWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerInitWithExtraParams.sol)
...
- Solidity implementation: [`KeyManagerInitWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerInitWithExtraParams.sol)
...
- Specification details: [**LSP-6-KeyManager**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-6-KeyManager.md#firstparam)
- Solidity implementation: [`KeyManagerInitWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerInitWithExtraParams.sol)
- Function signature: `firstParam()`
- Function selector: `0x6c46d762`

:::

```solidity
function firstParam() external view returns (address);
```
...
For more details, see the internal function [`_getNonce`](#`_getnonce`).
...
- Specification details: [**LSP-6-KeyManager**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-6-KeyManager.md#initialize)
- Solidity implementation: [`KeyManagerInitWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerInitWithExtraParams.sol)
...
```solidity
function initialize(address target_) external nonpayable;
```

_Initializing a LSP6KeyManagerInit linked to contract at address `target_`._
...
### initializeWithExtraParams

:::note References

- Specification details: [**LSP-6-KeyManager**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-6-KeyManager.md#initializewithextraparams)
- Solidity implementation: [`KeyManagerInitWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerInitWithExtraParams.sol)
- Function signature: `initializeWithExtraParams(address,address,address)`
- Function selector: `0x00dc68f1`
...
- Specification details: [**LSP-6-KeyManager**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-6-KeyManager.md#lastparam)
- Solidity implementation: [`KeyManagerInitWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerInitWithExtraParams.sol)
- Function signature: `lastParam()`
- Function selector: `0x65b70621`

:::

```solidity
function lastParam() external view returns (address);
```
...
```solidity
function _initialize(address target_) internal nonpayable;
```
...
- If the status is `false`, it is set to `true` only if we are not dealing with a call to the functions `setData` or `setDataBatch`. Used at the beginning of the [`lsp20VerifyCall`](#`lsp20verifycall`), [`_execute`](#`_execute`) and [`_executeRelayCall`](#`_executerelaycall`) functions, before the methods execution starts.
...
Resets the reentrancy status to `false` Used at the end of the [`lsp20VerifyCall`](#`lsp20verifycall`), [`_execute`](#`_execute`) and [`_executeRelayCall`](#`_executerelaycall`) functions after the functions' execution is terminated.
...
- Specification details: [**LSP-6-KeyManager**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-6-KeyManager.md#initialized)
- Solidity implementation: [`KeyManagerInitWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerInitWithExtraParams.sol)
