...
[`KeyManagerWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerWithExtraParams.sol)
...
- Solidity implementation: [`KeyManagerWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerWithExtraParams.sol)
...
- Specification details: [**LSP-6-KeyManager**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-6-KeyManager.md#first_param)
- Solidity implementation: [`KeyManagerWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerWithExtraParams.sol)
- Function signature: `FIRST_PARAM()`
- Function selector: `0x0549cf51`

:::

```solidity
function FIRST_PARAM() external view returns (address);
```
...
- Specification details: [**LSP-6-KeyManager**](https://github.com/lukso-network/LIPs/blob/main/LSPs/LSP-6-KeyManager.md#last_param)
- Solidity implementation: [`KeyManagerWithExtraParams.sol`](https://github.com/lukso-network/lsp-smart-contracts/tree/develop/packages/lsp23-contracts/contracts/mocks/KeyManagerWithExtraParams.sol)
- Function signature: `LAST_PARAM()`
- Function selector: `0x1865d8eb`

:::

```solidity
function LAST_PARAM() external view returns (address);
```
