...
// modules
import "./LSP0ERC725Account/LSP0ERC725AccountBis.sol";
 ...
 */
contract UniversalProfileBis is LSP0ERC725AccountBis {
    /**
     * @notice Sets the owner of the contract and sets the SupportedStandards:LSP3UniversalProfile key
     * @param _newOwner the owner of the contract
     */
    constructor(address _newOwner) LSP0ERC725AccountBis(_newOwner) {
