 ...
 */
abstract contract LSP0ERC725AccountBisCore is
    IERC1271,
        ...
        returns (bytes memory returnValue)
    {
        ...
        if (data.length >= 20) {
            ...
            if (
                ...
                // TODO: test
                bytes memory urdPayload = abi.encodeWithSelector(
                    ILSP1UniversalReceiverDelegate.universalReceiverDelegate.selector,
                    _msgSender(),
                    _typeId,
                    _data
                );

                (, returnValue) = universalReceiverDelegate.delegatecall(urdPayload);
