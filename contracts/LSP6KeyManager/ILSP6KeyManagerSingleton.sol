...
/**
 * @title Interface of the LSP6 Singleton - Key Manager standard, a contract acting as a controller of an ERC725 Account using predfined permissions.
 */
interface ILSP6KeyManagerSingleton is
    IERC1271
    /* is ERC165 */
{
    /**
     ...
     *
     * @param target The address of the contract you are executing the payload on.
