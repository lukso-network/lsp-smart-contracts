...
library LSP1Utils {
    /**
     * @dev query the storage of an ERC725Y smart contract to retrieve the value
     * stored under the `LSP1UniversalReceiverDelegate` data key
    ...
    /**
     * @dev query the storage of an ERC725Y smart contract to retrieve the value
     * stored under the `LSP1UniversalReceiverDelegate:<bytes32>` data key for a specific typeId.
     * @param erc725YStorage a reference to the ERC725Y storage mapping.
