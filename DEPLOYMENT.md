...
The per-contract and per-chain deployment registry has been moved to [`DEPLOYED_CHAINS.md`](./DEPLOYED_CHAINS.md), which scales better as support expands.

> See also: [DEPLOYED_CHAINS.md](./DEPLOYED_CHAINS.md) for the per-contract address registry.
...
| LSP7MintableInit                | 0.18.0  | `TBD`                                        | [**Solidity source code**](#)                                                                                                                                                                                         |
...
| LSP8MintableInit                | 0.18.0  | `TBD`                                        | [**Solidity source code**](#)                                                                                                                                                                                         |
